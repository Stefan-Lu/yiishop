...
echo '<link rel="stylesheet" href="/style/success.css" type="text/css">';
?>
...
<div class="success w990 bc mt15">
    ...
    <div class="success_bd">
        ...
        <p class="message">完成支付后，你可以 <a href="<?=\yii\helpers\Url::to(['goods/order-list'])?>">查看订单状态</a>  <a href="">继续购物</a> <a href="">问题反馈</a></p>
    </div>
</div>
<!-- 主体部分 end -->
