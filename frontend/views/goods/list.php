...
echo $this->render('@webroot/public/head');
?>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd none">
                ...
                <?=$this->render('@webroot/public/nav')?>
            </div>
                ...
                <?php
                   foreach ($goods as $good){
                    ...
                    <dl>
                        ...
                        <dd><a href="'.\yii\helpers\Url::to(['goods/goods','id'=>$good->id]).'">'.$good->name.'</a></dd>
                        <dd><strong>'.$good->shop_price.'</strong></dd>
                        <dd><a href="'.\yii\helpers\Url::to(['goods/goods','id'=>$good->id]).'"><em>已有'.$good->view_times.'人浏览</em></a></dd>
                    </dl>
                </li>
                    ';
                   }
