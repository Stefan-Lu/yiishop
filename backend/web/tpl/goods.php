    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=isset($gallerys[0]->path)? $gallerys[0]->path: ''?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=isset($gallerys[0]->path)?$gallerys[0]->path:''?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品浏览量：</span><strong></strong><a id="view"></a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?php echo (\yii\helpers\Url::to(['goods/add-to-cart']))?>" method="get" class="choose">
                    <input type="hidden" name="pid" value="<?php echo $goods->id?>">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
...
<script type="text/javascript">
    ...
    $.getJSON('<?php echo  \yii\helpers\Url::to(['goods/get-views'])?>',{'id':<?=$goods->id?>},function (data) {
        $('#view').text('已有'+data+'人评价');
    });
</script>
</body>
</html>