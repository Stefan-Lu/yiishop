...
<table class="table table-bordered" id="table_id_example">
    ...
    <?php foreach($rows as $row):?>
        <tr data-name="<?php echo $row->name?>">
            ...
            <td>
                <?php echo \yii\bootstrap\Html::a('修改',\yii\helpers\Url::to(['rbac/edit-permission','name'=>$row->name]),['class'=>'btn btn-primary btn-sm'])?>
...
$html=\yii\helpers\Url::to(['rbac/del-permission']).'?name=';
$js=<<<JS
    <!--第三步：初始化Datatables-->
